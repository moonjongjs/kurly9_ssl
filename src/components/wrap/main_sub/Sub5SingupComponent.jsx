...
export default function Sub5SingupComponent({회원가입}) {
    ...
    const emailDuplicateOk=(e)=>{
        ...
        if(regExp1.test(state.이메일) === true  || regExp2.test(state.이메일) === false){
            ...
            axios({
                // url:'http://moonjong2.dothome.co.kr/front9_kurly/emailCheckOk.php',
    ...
    const chooChunIdCheck=()=>{
        ...
        axios({
            // url:'http://moonjong2.dothome.co.kr/front9_kurly/idCheckOk.php',
            url:`${state.url}/idCheckOk.php`,
            method:'POST',
            data: formData
        })
    ...
    const onSubmitSignup=(e)=>{
        ...
        if(state.아이디===''){ // 필수 입력상자 빈칸체크
            ...
            axios({
                // url:'http://moonjong2.dothome.co.kr/front9_kurly/signup.php',
...
Sub5SingupComponent.defaultProps = {
    회원가입 : {
        url: `https://moonseonjong.com/front9_kurly`,
